...
Use a chord diagram to visualize the number of times the 10 most frequently appearing characters in GoT appear together in a scene. Interestingly Tyrion has a lot of scenes with the top 10 characters, while Arya has very few. Jon and Daenerys and Jon have a lot of scenes but Daenerys primarily has scenes with Jorah, Jon and Tyrian. The siblings Cersei, Jamie and Tyrian have a lotof scenes with each other but the siblings Sansa, Arya and Bran have much fewer which makes sense based on the story.

Data source: https://www.kaggle.com/shivamb/netflix-shows

<img src="18-connections/got_connections.png" title="Use a chord diagram to visualize the number of times the 10 most frequently appearing characters in GoT appear together in a scene. Interestingly Tyrion has a lot of scenes with the top 10 characters, while Arya has very few. Jon and Daenerys and Jon have a lot of scenes but Daenerys primarily has scenes with Jorah, Jon and Tyrian. The siblings Cersei, Jamie and Tyrian have a lotof scenes with each other but the siblings Sansa, Arya and Bran have much fewer which makes sense based on the story." alt="Use a chord diagram to visualize the number of times the 10 most frequently appearing characters in GoT appear together in a scene. Interestingly Tyrion has a lot of scenes with the top 10 characters, while Arya has very few. Jon and Daenerys and Jon have a lot of scenes but Daenerys primarily has scenes with Jorah, Jon and Tyrian. The siblings Cersei, Jamie and Tyrian have a lotof scenes with each other but the siblings Sansa, Arya and Bran have much fewer which makes sense based on the story." width="3500" />
